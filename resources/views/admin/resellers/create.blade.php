<x-panel-layout title="Nuevo revendedor">
    <form method="POST" action="{{ route('admin.resellers.store') }}" class="max-w-xl space-y-4 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
        @csrf
        <div>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.resellers.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm dark:border-gray-600">Volver</a>
        </div>
    </form>
</x-panel-layout>
